...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Monitor, track, and follow up on faculty Post-Activity Report submissions for your institution." },
      { property: "og:title", content: "FPARTS — Faculty Post-Activity Report Tracking" },
      { property: "og:description", content: "Monitor, track, and follow up on faculty Post-Activity Report submissions for your institution." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "FPARTS — Faculty Post-Activity Report Tracking" },
      { name: "twitter:description", content: "Monitor, track, and follow up on faculty Post-Activity Report submissions for your institution." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/fbe0a1e5-5c8f-459f-bc14-999209fce88f/id-preview-76db63ae--1d8f1949-74ae-4785-9cb0-1991a70b13d9.lovable.app-1783680110349.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/fbe0a1e5-5c8f-459f-bc14-999209fce88f/id-preview-76db63ae--1d8f1949-74ae-4785-9cb0-1991a70b13d9.lovable.app-1783680110349.png" },
    ],
    links: [

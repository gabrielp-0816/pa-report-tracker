  ...
  head: () => ({
    meta: [
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/fbe0a1e5-5c8f-459f-bc14-999209fce88f/id-preview-76db63ae--1d8f1949-74ae-4785-9cb0-1991a70b13d9.lovable.app-1783680110349.png",
      },
      {
        name: "twitter:image",
        content:
    ...
    links: [
      ...
      { rel: "icon", href: "/pup-logo.svg", type: "image/svg+xml" },
    ],
  }),
